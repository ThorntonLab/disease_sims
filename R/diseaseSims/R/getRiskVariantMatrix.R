...
getVariantMatrix = function(popfilename,
    popfileOffset,
    phenofilename,
    phenofileOffset,
    modelName = "recessive",
    ...
    selectedOnly = TRUE)
    {
        ...
        if( missing(phenofilename) )
            {
                XX = .getVariantMatrixDetails(modelName,popfilename,popfileOffset,dominance,selectedOnly)
                return (XX);
            }
        ...
        XX=.getVariantMatrixDetailsPheno(modelName,popfilename,popfileOffset,phenofilename,phenofileOffset,dominance,selectedOnly)
        return (XX);
    }

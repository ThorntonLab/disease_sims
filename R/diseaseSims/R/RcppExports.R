...
.reformatCCgenos <- function(m) {
    .Call('diseaseSims_reformactCCgenos', PACKAGE = 'diseaseSims', m)
}

.getVariantMatrixDetails <- function(model, popfile, popfile_offset, dominance = 0., selectedOnly = TRUE) {
    .Call('diseaseSims_getVariantMatrixDetails', PACKAGE = 'diseaseSims', model, popfile, popfile_offset, dominance, selectedOnly)
}

.getVariantMatrixDetailsPheno <- function(model, popfile, popfile_offset, phenofile, phenofile_offset, dominance = 0., selectedOnly = TRUE) {
    .Call('diseaseSims_getVariantMatrixDetails_Pheno', PACKAGE = 'diseaseSims', model, popfile, popfile_offset, phenofile, phenofile_offset, dominance, selectedOnly)
}

.getVariantMatrixDetailsSubset <- function(model, popfile, popfile_offset, phenofile, phenofile_offset, subset, nsample, dominance = 0., selectedOnly = FALSE) {
    .Call('diseaseSims_getVariantMatrixDetails_Subset', PACKAGE = 'diseaseSims', model, popfile, popfile_offset, phenofile, phenofile_offset, subset, nsample, dominance, selectedOnly)
}

.getVariantMatrixDetailsSubsetGE <- function(model, popfile, popfile_offset, phenofile, phenofile_offset, subset, nsample, dominance = 0., selectedOnly = FALSE) {

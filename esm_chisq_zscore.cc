...
params parse_command_line(int argc, char ** argv)
{
  ...
  */
  ...
  desc.add_options()
    ...
    ("maxcontrols",value<unsigned>(&rv.max_controls),"Max number of control individuals to use in analysis")
    ("maxcases",value<unsigned>(&rv.max_cases),"Max number of case individuals to use in analysis")

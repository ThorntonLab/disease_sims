...
R --no-save --slave --args simindex.txt ccindex.txt popfile.bin 0 ccfile.bin 100 100 1000 pvalues.txt pvalues_index.txt ./atomic_locker/atomic_locker < single_marker_test.R
